...
class StepContentLocations extends StatelessWidget {
  const StepContentLocations({
    super.key,
    required this.lang,
  ...
  Widget build(BuildContext context) {
    ...
    return Column(
      ...
      children: [
        Text(
          obString(OnboardingStep.locations, 'title', lang),
          style: theme.textTheme.headlineSmall,
          textAlign: TextAlign.center,
        ),
        const SizedBox(height: 12),
        Text(
          obString(OnboardingStep.locations, 'body', lang),

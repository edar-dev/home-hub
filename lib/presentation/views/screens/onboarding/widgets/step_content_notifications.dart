...
class StepContentNotifications extends StatelessWidget {
  const StepContentNotifications({
    super.key,
    required this.lang,
  ...
  Widget build(BuildContext context) {
    ...
    return Column(
      ...
      children: [
        Text(
          obString(OnboardingStep.notifications, 'title', lang),
          style: theme.textTheme.headlineSmall,
          textAlign: TextAlign.center,
        ),
        const SizedBox(height: 12),
        Text(
          obString(OnboardingStep.notifications, 'body', lang),

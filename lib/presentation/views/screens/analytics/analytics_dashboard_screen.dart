...
class _AnalyticsDashboardScreenState extends State<AnalyticsDashboardScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: analytics.isLoading && m == null
              ...
              child: ListView(
                ...
                children: [
                  ...
                  if (m != null) ...[
                        ...
                        return GridView.count(
                          ...
                          children: [
                            ...
                            MetricCard(
                              ...
                              subtitle: 'Sprechi ${m.wastePercentage.toStringAsFixed(1)}%',
                            ),
                            MetricCard(
                              title: 'Consumo / mese (stima)',
                              value: m.monthlyConsumptionAverage.toStringAsFixed(1),
                              subtitle: 'Unità implicite',
                            ),
                          ],
                        );
                      },
                    ...
                    const SizedBox(height: 8),
                    LocationPieChart(points: analytics.locationDistribution),
                    const SizedBox(height: 24),
                    Text(
                    ...
                    ConsumptionLineChart(points: analytics.consumptionTrend),
                  ],
                ],
              ),
            ),
